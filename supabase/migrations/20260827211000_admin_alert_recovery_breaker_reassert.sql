...
-- Reassert the lightweight reader after the stable-rule rollback migration.
-- Keep alert rows and authorization intact while the reader is redesigned
-- around precomputed data and a fixed interactive connection budget.
