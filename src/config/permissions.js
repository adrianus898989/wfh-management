...
export const PERMISSIONS = {
  ...
  EMPLOYEE_DIRECTORY_PAYROLL_RECORDS_VIEW: 'employee.directory.payroll_records.view',
  ...
  STAFF_ACCOUNT_UNLOCK: 'staff_account.unlock',
  ...
  BACKEND_ACCOUNT_UNLOCK: 'backend_account.unlock',
  BACKEND_ACCOUNT_LOCKOUT_POLICY_MANAGE: 'backend_account.lockout_policy_manage',
  ACCOUNT_ONLINE_PRESENCE_VIEW: 'account.online_presence.view',
...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      [PERMISSIONS.STAFF_ACCOUNT_UNLOCK, '解锁员工登录账号'],
      [PERMISSIONS.ACCOUNT_VIEW, '查看后台账号'],
      [PERMISSIONS.ACCOUNT_ONLINE_PRESENCE_VIEW, '查看后台与员工在线名单'],
      ...
      [PERMISSIONS.BACKEND_ACCOUNT_UNLOCK, '解锁后台登录账号'],
      [PERMISSIONS.BACKEND_ACCOUNT_LOCKOUT_POLICY_MANAGE, '设置密码错误锁定阈值'],
