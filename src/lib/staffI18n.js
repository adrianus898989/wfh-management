...
const en = {
  ...
  'connectivity.previewFailed': 'Preview unavailable. You can retry or open the original file.',
  'connectivity.retry': 'Retry preview',
  'connectivity.openOriginal': 'Open original file',
