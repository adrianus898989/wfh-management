...
const en = {
  ...
  'auth.accountLocked': 'This account is locked after {count} incorrect password attempts. Contact an administrator to unlock it.',
  'auth.accountLockedWithoutCount': 'This account is locked after too many incorrect password attempts. Contact an administrator to unlock it.',
  ...
  'auth.forgotPasswordContactAdmin': 'Forgot your password? Contact an administrator to reset it.',
  'passwordChange.open': 'Change password',
  'passwordChange.title': 'Change password',
  'passwordChange.description': 'Verify your current password. All signed-in sessions will end after the change.',
  'passwordChange.current': 'Current password',
  'passwordChange.next': 'New password',
  'passwordChange.confirm': 'Confirm new password',
  'passwordChange.rules': 'New password requirements',
  'passwordChange.invalidRequest': 'Invalid request. Please reopen this dialog and try again.',
  'passwordChange.currentRequired': 'Enter your current password.',
  'passwordChange.requirements': 'Complete all new-password requirements.',
  'passwordChange.reuse': 'Choose a password different from your current password.',
  'passwordChange.incorrect': 'The current password is incorrect.',
  'passwordChange.locked': 'This account is locked. Contact an administrator.',
  'passwordChange.accountUnavailable': 'This staff account is no longer available.',
  'passwordChange.sessionEnded': 'Your session has ended. Sign in again.',
  'passwordChange.sessionCheckFailed': 'Unable to verify this session right now. Try again later.',
  'passwordChange.networkDenied': 'This network is not allowed to change the staff password.',
  'passwordChange.tooManyAttempts': 'Too many attempts. Try again later.',
  'passwordChange.unavailable': 'Password change is temporarily unavailable. Try again later.',
  'passwordChange.failed': 'Unable to change the password. Try again.',
  'passwordChange.mismatch': 'The new passwords do not match.',
  'passwordChange.saving': 'Changing…',
  'passwordChange.submit': 'Change password',
  'passwordChange.success': 'Password changed. Sign in again with your new password.',
  'passwordChange.finalizePending': 'Your password changed, but session cleanup is still finishing. Try the new password shortly or contact an administrator.',
  'passwordChange.outcomeUnknown': 'The result could not be confirmed. Try your new password first; if it does not work, try the old one or contact an administrator.',
  ...
  'adjustments.recordTitle': 'Title',
  'adjustments.date': 'Date',
  'adjustments.type': 'Type',
  'adjustments.amount': 'Amount',
  'adjustments.reason': 'Reason',
  'adjustments.loadFailed': 'Failed to load reward and deduction records.',
  ...
  'exam.imageOnlyAnswer': '(Images only)',
  'exam.answerImages': 'Answer images',
  'exam.feedback': 'Reviewer feedback',
  'exam.feedbackImages': 'Reviewer images',
  'exam.imageUnavailable': 'Image preview temporarily unavailable',
...
const zh = {
  ...
  'auth.forgotPasswordContactAdmin':'忘记密码请联系管理员重置。',
  'passwordChange.open':'修改密码','passwordChange.title':'修改密码','passwordChange.description':'请先验证当前密码。修改成功后，所有已登录会话都会退出。','passwordChange.current':'当前密码','passwordChange.next':'新密码','passwordChange.confirm':'确认新密码','passwordChange.rules':'新密码要求','passwordChange.invalidRequest':'请求格式不正确，请关闭窗口后重试。','passwordChange.currentRequired':'请输入当前密码。','passwordChange.requirements':'请完成全部新密码要求。','passwordChange.reuse':'新密码不能与当前密码相同。','passwordChange.incorrect':'当前密码不正确。','passwordChange.locked':'账号已锁定，请联系管理员。','passwordChange.accountUnavailable':'员工账号已不可用。','passwordChange.sessionEnded':'登录会话已失效，请重新登录。','passwordChange.sessionCheckFailed':'暂时无法验证当前会话，请稍后重试。','passwordChange.networkDenied':'当前网络不允许修改员工密码。','passwordChange.tooManyAttempts':'尝试次数过多，请稍后重试。','passwordChange.unavailable':'暂时无法修改密码，请稍后重试。','passwordChange.failed':'密码修改失败，请重试。','passwordChange.mismatch':'两次输入的新密码不一致。','passwordChange.saving':'修改中…','passwordChange.submit':'确认修改','passwordChange.success':'密码已修改，请使用新密码重新登录。','passwordChange.finalizePending':'密码已修改，但会话清理仍在完成中；请稍后使用新密码登录，或联系管理员。','passwordChange.outcomeUnknown':'暂时无法确认修改结果。请先尝试新密码；若无法登录，再尝试旧密码或联系管理员。',
...
const vi = {
  ...
  'auth.forgotPasswordContactAdmin':'Quên mật khẩu? Hãy liên hệ quản trị viên để đặt lại.',
  'passwordChange.open':'Đổi mật khẩu','passwordChange.title':'Đổi mật khẩu','passwordChange.description':'Xác minh mật khẩu hiện tại. Tất cả phiên đăng nhập sẽ kết thúc sau khi đổi.','passwordChange.current':'Mật khẩu hiện tại','passwordChange.next':'Mật khẩu mới','passwordChange.confirm':'Xác nhận mật khẩu mới','passwordChange.rules':'Yêu cầu mật khẩu mới','passwordChange.invalidRequest':'Yêu cầu không hợp lệ. Hãy đóng hộp thoại và thử lại.','passwordChange.currentRequired':'Nhập mật khẩu hiện tại.','passwordChange.requirements':'Hoàn tất mọi yêu cầu cho mật khẩu mới.','passwordChange.reuse':'Chọn mật khẩu khác với mật khẩu hiện tại.','passwordChange.incorrect':'Mật khẩu hiện tại không đúng.','passwordChange.locked':'Tài khoản đã bị khóa. Hãy liên hệ quản trị viên.','passwordChange.accountUnavailable':'Tài khoản nhân viên không còn khả dụng.','passwordChange.sessionEnded':'Phiên đã kết thúc. Vui lòng đăng nhập lại.','passwordChange.sessionCheckFailed':'Hiện không thể xác minh phiên. Vui lòng thử lại sau.','passwordChange.networkDenied':'Mạng này không được phép đổi mật khẩu nhân viên.','passwordChange.tooManyAttempts':'Thử quá nhiều lần. Vui lòng thử lại sau.','passwordChange.unavailable':'Tạm thời không thể đổi mật khẩu. Vui lòng thử lại sau.','passwordChange.failed':'Không thể đổi mật khẩu. Vui lòng thử lại.','passwordChange.mismatch':'Hai mật khẩu mới không khớp.','passwordChange.saving':'Đang đổi…','passwordChange.submit':'Đổi mật khẩu','passwordChange.success':'Đã đổi mật khẩu. Hãy đăng nhập lại bằng mật khẩu mới.','passwordChange.finalizePending':'Mật khẩu đã đổi nhưng việc dọn phiên vẫn đang hoàn tất. Hãy thử mật khẩu mới sau ít phút hoặc liên hệ quản trị viên.','passwordChange.outcomeUnknown':'Không thể xác nhận kết quả. Hãy thử mật khẩu mới trước; nếu không được, thử mật khẩu cũ hoặc liên hệ quản trị viên.',
...
const id = {
  ...
  'auth.forgotPasswordContactAdmin':'Lupa kata sandi? Hubungi administrator untuk mengatur ulang.',
  'passwordChange.open':'Ubah kata sandi','passwordChange.title':'Ubah kata sandi','passwordChange.description':'Verifikasi kata sandi saat ini. Semua sesi akan berakhir setelah perubahan.','passwordChange.current':'Kata sandi saat ini','passwordChange.next':'Kata sandi baru','passwordChange.confirm':'Konfirmasi kata sandi baru','passwordChange.rules':'Syarat kata sandi baru','passwordChange.invalidRequest':'Permintaan tidak valid. Tutup dialog dan coba lagi.','passwordChange.currentRequired':'Masukkan kata sandi saat ini.','passwordChange.requirements':'Lengkapi semua syarat kata sandi baru.','passwordChange.reuse':'Pilih kata sandi yang berbeda dari kata sandi saat ini.','passwordChange.incorrect':'Kata sandi saat ini salah.','passwordChange.locked':'Akun ini terkunci. Hubungi administrator.','passwordChange.accountUnavailable':'Akun staf ini sudah tidak tersedia.','passwordChange.sessionEnded':'Sesi Anda telah berakhir. Silakan masuk kembali.','passwordChange.sessionCheckFailed':'Sesi belum dapat diverifikasi. Coba lagi nanti.','passwordChange.networkDenied':'Jaringan ini tidak diizinkan untuk mengubah kata sandi staf.','passwordChange.tooManyAttempts':'Terlalu banyak percobaan. Coba lagi nanti.','passwordChange.unavailable':'Perubahan kata sandi sementara tidak tersedia. Coba lagi nanti.','passwordChange.failed':'Kata sandi tidak dapat diubah. Coba lagi.','passwordChange.mismatch':'Kata sandi baru tidak cocok.','passwordChange.saving':'Mengubah…','passwordChange.submit':'Ubah kata sandi','passwordChange.success':'Kata sandi telah diubah. Masuk kembali dengan kata sandi baru.','passwordChange.finalizePending':'Kata sandi telah diubah, tetapi pembersihan sesi masih berlangsung. Coba kata sandi baru sebentar lagi atau hubungi administrator.','passwordChange.outcomeUnknown':'Hasilnya belum dapat dipastikan. Coba kata sandi baru terlebih dahulu; jika gagal, coba kata sandi lama atau hubungi administrator.',
