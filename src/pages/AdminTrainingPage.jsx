...
const breakdown=x=>x.source_system==='legacy'
  ?(x.answer_detail_available?`有得分 ${x.scored_answer_count||0} · 零分 ${x.zero_score_answer_count||0}`:'逐题答案尚未同步')
  :`正确 ${x.correct_count||0} · 半对 ${x.partial_count||0} · 错误 ${x.wrong_count||0}`
