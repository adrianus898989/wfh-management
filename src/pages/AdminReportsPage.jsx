...
function ReportEmployeeDrawer({employeeNo,onClose}){
  ...
  const detail=state.detail||{},employee=detail.employee||{},contact=detail.contact||{},payment=detail.payment||{},compensation=detail.compensation||{},summary=state.profileSummary||{},missing=detail.missing_fields||[],grade=errorGradeLabel(errorGradeKey(summary.total_errors))
