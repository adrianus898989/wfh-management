...
export default function StaffPayrollPage(){
  ...
  if(state.loading)return <div className="content-page staff-payroll-page"><div className="payroll-state">{t.loading}</div></div>
  if(state.error)return <div className="content-page staff-payroll-page"><div className="payroll-alert error">{t.error}：{state.error}</div></div>
  const history=state.data?.history||[]

  return <div className="content-page staff-payroll-page">
